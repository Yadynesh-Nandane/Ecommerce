...
const EditUserLoginPage = () => {
  ...
  useEffect(() => {
    if (!isAuthenticated && (user === null || undefined)) navigate("/signin");
  ...
  return (
    <>
      <div className="w-full h-screen">
        <header className="w-full h-20 flex items-center justify-center bg-[#131921]">
          <Link to="/">
            <img
              src=""
        ...
        <main className="w-full p-5">
          ...
          >
            <div className={fieldName === "name" ? "flex flex-col " : "hidden"}>
              <h1 className="text-2xl font-semibold mb-5">Change Your Name</h1>
              <div className="mb-5">
                ...
                <span className="font-semibold">Save Changes</span> button when
                you are done.
              </div>
            ...
            <div className={fieldName === "email" ? "flex flex-col" : "hidden"}>
            ...
            <div
              className={
                fieldName === "mobilephonenumber" ? "flex flex-col" : "hidden"
              }
            >
              <h1 className="text-2xl font-semibold mb-5">
            ...
            <input
              type="submit"
              value="Save Changes"
              className="text-lg p-3 w-full font-semibold rounded-lg bg-[#f3a847] cursor-pointer"
            />
          </form>
        </main>
      </div>
